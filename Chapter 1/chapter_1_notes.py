...
if __name__ == "__main__":
    print("Printing: {}".format(Fraction(3, 5)))
    print("Addition: {}".format(Fraction(2, 5) + Fraction(1, 5)))
    print("Subtraction: {}".format(Fraction(1, 3) - Fraction(1, 2)))
    print("Equality: {}".format(Fraction(1, 4) == Fraction(4, 16)))
    print("Multiplication: {}".format(Fraction(2, 3) * Fraction(6, 7)))
    print("Division: {}".format(Fraction(3, 4) / Fraction(1, 8)))
